...
const ArquiteturaSolucoes = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  const whatsappNumber = "5521982837322";
  const whatsappMessage = encodeURIComponent("Tenho interesse no treinamento de Arquitetura de Soluções!");
  const whatsappUrl = `https://wa.me/${whatsappNumber}?text=${whatsappMessage}`;

  const modules = [
    "Fundamentos de Arquitetura de Software",
    "Padrões de Arquitetura (MVC, MVVM, Clean)",
    "Microserviços e APIs",
    "Domain-Driven Design (DDD)",
    "Event-Driven Architecture",
    "CQRS e Event Sourcing",
    "Arquitetura Hexagonal",
    "Non-Functional Requirements e Quality Attributes"
  ];

  const benefits = [
    "Projete sistemas escaláveis",
    "Reduza débito técnico",
    "Melhore manutenibilidade do código",
    "Aumente performance das aplicações",
    "Facilite integração entre sistemas",
    "Tome decisões arquiteturais assertivas"
  ];
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl">
              ...
              <p className="text-xl md:text-2xl mb-8 text-primary-foreground/90">
                Projete soluções escaláveis e robustas para seus desafios de negócio
              </p>
              <Button 
                size="lg" 
        ...
        <section className="py-20 bg-accent">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Construa soluções de classe mundial
            </h2>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Aprenda com especialistas que já arquitetaram sistemas para empresas líderes de mercado
            </p>
            <Button 
              size="lg" 
...
export default ArquiteturaSolucoes;
