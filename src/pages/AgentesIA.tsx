...
const AgentesIA = () => {
  ...
  const benefits = [
    "Crie agentes inteligentes autônomos",
    "Integre LLMs em suas aplicações",
    "Automatize tarefas complexas com IA",
    "Construa assistentes personalizados",
    "Domine as tecnologias mais recentes",
    "Implemente soluções inovadoras"
  ];
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl">
              ...
              <p className="text-xl md:text-2xl mb-8 text-primary-foreground/90">
                Crie agentes inteligentes autônomos com as tecnologias mais recentes
              </p>
              <Button 
                size="lg" 
        ...
        <section className="py-20 bg-accent">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Construa o futuro com agentes de IA
            </h2>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Seja pioneiro na construção de sistemas inteligentes que transformam negócios
            </p>
            <Button 
              size="lg" 
