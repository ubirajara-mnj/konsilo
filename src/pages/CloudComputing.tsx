...
const CloudComputing = () => {
  ...
  const whatsappMessage = encodeURIComponent("Tenho interesse no treinamento de Cloud Computing!");
  ...
  const modules = [
    ...
    "Cloud Security e Best Practices",
    "FinOps e Cost Optimization"
  ];

  const benefits = [
    "Domine as principais plataformas cloud",
    "Reduza custos de infraestrutura",
    "Escale aplicações automaticamente",
    "Implemente alta disponibilidade",
    "Acelere deploy de aplicações",
    "Prepare-se para certificações"
  ];
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl">
              ...
              <p className="text-xl md:text-2xl mb-8 text-primary-foreground/90">
                Domine as principais plataformas cloud e estratégias de migração
              </p>
              <Button 
                size="lg" 
        ...
        <section className="py-20 bg-accent">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Aprenda com quem já migrou centenas de aplicações para cloud em projetos reais
            </p>
            <Button 
              size="lg" 
