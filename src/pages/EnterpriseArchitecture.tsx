...
const EnterpriseArchitecture = () => {
  ...
  const whatsappMessage = encodeURIComponent("Tenho interesse no treinamento de Enterprise Architecture!");
  ...
  const modules = [
    ...
    "Cloud Strategy e Migration Planning"
  ];

  const benefits = [
    "Alinhe TI com estratégia de negócio",
    "Reduza custos operacionais",
    "Melhore governança corporativa",
    "Otimize investimentos em tecnologia",
    "Acelere transformação digital",
    "Padronize processos e sistemas"
  ];
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl">
              ...
              <p className="text-xl md:text-2xl mb-8 text-primary-foreground/90">
                Estruture e otimize sua arquitetura corporativa para máxima eficiência
              </p>
              <Button 
                size="lg" 
        ...
        <section className="py-20 bg-accent">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Eleve sua arquitetura corporativa ao próximo nível
            </h2>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Fale com nossos especialistas e descubra como estruturar uma arquitetura que suporte o crescimento do seu negócio
            </p>
            <Button 
              size="lg" 
